    ...
    public partial class FrmMusteriCikis : Form
    {
        ...
        private void DoluOdalar()
        {
            try
            {
                ...
                cmbParkYeriSec.DisplayMember = "Oda_Numarasi";
                cmbParkYeriSec.ValueMember = "Oda_Numarasi";
                cmbParkYeriSec.DataSource = order;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Hata oluştu: " + ex.Message);
        ...
        private void cmbOdaNumari_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                muster.OdaNo1 = cmbParkYeriSec.SelectedValue.ToString();
        ...
        private void btnMusteriCikisi_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbOdaAra.Items.Clear();
                cmbParkYeriSec.Items.Clear();
                DoluOdalar();
                MusteriGetir();
            }
            catch (Exception ex)
