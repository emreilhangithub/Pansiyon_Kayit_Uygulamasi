    ...
    public partial class FrmYeniMusteri : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(musteri.Ad1) || string.IsNullOrEmpty(musteri.Soyad1) || string.IsNullOrEmpty(musteri.Cinsiyet1) || string.IsNullOrEmpty(musteri.Telefon1) || string.IsNullOrEmpty(musteri.Mail1) || string.IsNullOrEmpty(musteri.Tc1) || string.IsNullOrEmpty(musteri.OdaNo1) || string.IsNullOrEmpty(musteri.GirisTarihi1.ToString()))
                {
